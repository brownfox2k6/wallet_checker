...
def get_token_balance(
    contract_address: str, address: str, chainid: int = 1, tag: str = "latest"
) -> int:
    """
...
def get_token_holders(
    contract_address: str, page: int = 1, offset: int = 10, chainid: int = 1
) -> list[dict]:
    """
...
def get_address_token_holdings(
    address: str, page: int = 1, offset: int = 100, chainid: int = 1
) -> list[dict]:
    """
